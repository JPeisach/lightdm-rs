...
pub trait SessionExt: IsA<Session> + 'static {
    ...
    fn comment(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::lightdm_session_get_comment(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn key(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::lightdm_session_get_key(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn name(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::lightdm_session_get_name(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn session_type(&self) -> Option<glib::GString> {
        unsafe {
            from_glib_none(ffi::lightdm_session_get_session_type(self.as_ref().to_glib_none().0))
        }
    }

    #[doc(alias = "comment")]
    fn connect_comment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_comment_trampoline<P: IsA<Session>, F: Fn(&P) + 'static>(this: *mut ffi::LightDMSession, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) { unsafe {
            let f: &F = &*(f as *const F);
            f(Session::from_glib_borrow(this).unsafe_cast_ref())
        }}
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::comment".as_ptr(),
    ...
    fn connect_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_key_trampoline<P: IsA<Session>, F: Fn(&P) + 'static>(this: *mut ffi::LightDMSession, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) { unsafe {
            let f: &F = &*(f as *const F);
            f(Session::from_glib_borrow(this).unsafe_cast_ref())
        }}
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, c"notify::key".as_ptr(),
    ...
    fn connect_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_name_trampoline<P: IsA<Session>, F: Fn(&P) + 'static>(this: *mut ffi::LightDMSession, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer) { unsafe {
            let f: &F = &*(f as *const F);
            f(Session::from_glib_borrow(this).unsafe_cast_ref())
        }}
        unsafe {
