...
unsafe extern "C" {
    ...
    pub fn lightdm_greeter_authenticate(greeter: *mut LightDMGreeter, username: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_authenticate_as_guest(greeter: *mut LightDMGreeter, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_authenticate_autologin(greeter: *mut LightDMGreeter, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_authenticate_remote(greeter: *mut LightDMGreeter, session: *const c_char, username: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_cancel_authentication(greeter: *mut LightDMGreeter, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_cancel_autologin(greeter: *mut LightDMGreeter);
    pub fn lightdm_greeter_connect_sync(greeter: *mut LightDMGreeter, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_connect_to_daemon(greeter: *mut LightDMGreeter, cancellable: *mut gio::GCancellable, callback: gio::GAsyncReadyCallback, user_data: gpointer);
    pub fn lightdm_greeter_connect_to_daemon_finish(greeter: *mut LightDMGreeter, result: *mut gio::GAsyncResult, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_connect_to_daemon_sync(greeter: *mut LightDMGreeter, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_ensure_shared_data_dir(greeter: *mut LightDMGreeter, username: *const c_char, cancellable: *mut gio::GCancellable, callback: gio::GAsyncReadyCallback, user_data: gpointer);
    pub fn lightdm_greeter_ensure_shared_data_dir_finish(greeter: *mut LightDMGreeter, result: *mut gio::GAsyncResult, error: *mut *mut glib::GError) -> *mut c_char;
    pub fn lightdm_greeter_ensure_shared_data_dir_sync(greeter: *mut LightDMGreeter, username: *const c_char, error: *mut *mut glib::GError) -> *mut c_char;
    ...
    pub fn lightdm_greeter_get_autologin_session_hint(greeter: *mut LightDMGreeter) -> *const c_char;
    ...
    pub fn lightdm_greeter_get_hint(greeter: *mut LightDMGreeter, name: *const c_char) -> *const c_char;
    ...
    pub fn lightdm_greeter_respond(greeter: *mut LightDMGreeter, response: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_set_language(greeter: *mut LightDMGreeter, language: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_set_resettable(greeter: *mut LightDMGreeter, resettable: gboolean);
    pub fn lightdm_greeter_start_session(greeter: *mut LightDMGreeter, session: *const c_char, cancellable: *mut gio::GCancellable, callback: gio::GAsyncReadyCallback, user_data: gpointer);
    pub fn lightdm_greeter_start_session_finish(greeter: *mut LightDMGreeter, result: *mut gio::GAsyncResult, error: *mut *mut glib::GError) -> gboolean;
    pub fn lightdm_greeter_start_session_sync(greeter: *mut LightDMGreeter, session: *const c_char, error: *mut *mut glib::GError) -> gboolean;
    ...
    pub fn lightdm_language_matches(language: *mut LightDMLanguage, code: *const c_char) -> gboolean;
    ...
    pub fn lightdm_user_list_get_user_by_name(user_list: *mut LightDMUserList, username: *const c_char) -> *mut LightDMUser;
